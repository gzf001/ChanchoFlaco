...
<div id="gastos" class="contenido">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="row ">
       ...
       <input class="campo-texto campo-texto-tipogasto" type="text" placeholder="Escribe tu gasto: celular, comida, etc">
        </div>
       </div>
      </div> 
       ...
       <div class="col-xs-6">  
        <div class="form-group"> 
        <input class="form-control campotexto-grueso" id="calendar-gastos" name="fecha-gasto" placeholder="MM/DD/AAA" type="text" readonly="readonly" >  
        </div>    
        </div>
         <div class="col-xs-6">  
        <div class="form-group"> 
      ...
      <div class="row distribucion">
         ...
         <input class="campo-texto espacio-signo-dolar"  type="number">
          </div>
         </div>
      </div> 
 ...
 <div class="row">
  ...
  <div class="row seleccion-categoria-gastos">
      <div class="col-xs-4"><input class="cat-gastos" id="alimentacion" name="alimentacion" type="radio" value="Basicos"><label id="alimentacion-img" for="alimentacion"></label></div>
  ...
  <div class="row seleccion-categoria-gastos">
      <div class="col-xs-4"><input class="cat-gastos" id="locomocion" name="locomocion" type="radio" value="locomocion"><label id="locomocion-img" for="locomocion"></label></div>
      <div class="col-xs-8"><p class="selec-cat-titulo">Locomoción</p> <p class="select-cat-bajada">(locomoción: bencina, micro, etc.)</p></div> 
  </div>

  <div class="row seleccion-categoria-gastos">
      <div class="col-xs-4"><input class="cat-gastos" id="Tarjetas" name="Tarjetas" type="radio" value="Credito"><label id="Tarjetas-img" for="Tarjetas"></label></div>
