<div id="seleccionar-categoria-gastos" class="container " >
 ...
 <div class="row">
  ...
  <form action="">
    ...
    <div class="row seleccion-categoria-gastos">
      <div class="col-xs-4"><input id="Arriendo-divi" name="Arriendo-divi" type="radio" value="Arriendo"><label id="Arriendo-divi-img" for="Arriendo-divi"></label></div>
  ...
  <div class="row seleccion-categoria-gastos">
      <div class="col-xs-4"><input id="alimentacion" name="alimentacion" type="radio" value="Basicos"><label id="alimentacion-img" for="alimentacion"></label></div>
  ...
  <div class="row seleccion-categoria-gastos">
      <div class="col-xs-4"><input id="locomocion" name="locomocion" type="radio" value="locomocion"><label id="locomocion-img" for="locomocion"></label></div>
      <div class="col-xs-8"><p class="selec-cat-titulo">Locomoción</p> <p class="select-cat-bajada">(locomoción: bencina, micro, etc.)</p></div> 
  </div>

  <div class="row seleccion-categoria-gastos">
      <div class="col-xs-4"><input id="Tarjetas" name="Tarjetas" type="radio" value="Credito"><label id="Tarjetas-img" for="Tarjetas"></label></div>
    ...
    <div class="row seleccion-categoria-gastos">
      <div class="col-xs-4"><input id="Ocio" name="Ocio" type="radio" value="Ocio"><label id="Ocio-img" for="Ocio"></label></div>
      <div class="col-xs-8"><p class="selec-cat-titulo">Ocio</p> <p class="select-cat-bajada">(Ocio, entretencion, cine, musica, etc.)</p></div> 
  </div>

    <div class="row seleccion-categoria-gastos">
      <div class="col-xs-4"><input id="otros-gastos" name="otros-gastos" type="radio" value="Otros"><label id="otros-img" for="otros-gastos"></label></div>
